...
export const SCRIPTS = {
  ...
  deepvoiceConcept: "이번엔 '딥보이스'를 알아볼게요. 짧은 목소리 샘플만 있으면, AI가 그 사람의 목소리를 흉내 낼 수 있는 기술이에요. 예를 들어, 제가 '안녕하세요' 한 마디만 녹음해도 AI는 제 목소리로 '나는 지금 해외에 있어. 돈 좀 보내줘.' 같은 말을 만들어낼 수 있어요.",
  deepfakeVideoIntro: "그러면 딥페이크, 딥보이스가 어떻게 만들어지는지 짧은 영상을 통해 함께 알아볼게요.",
  genAIConcept: "그런데 요즘은 단순히 얼굴과 목소리를 바꾸는 걸 넘어서, '사람 자체를 새로 만들어내는 AI'도 등장했어요. 실제로 존재하지 않는 사람의 얼굴 목소리, 심지어 말투와 감정 표현까지 AI가 만들어내는 거죠. AI가 만든 영상을 '생성형 AI 영상'라고도 불러요.",
  deepfakeWrapup: "딥페이크, 딥보이스, 생성형 AI… 알아야할 게 너무 많죠. 이제는 AI가 얼굴과 목소리를 넘어서, 사람 자체를 만들어 가짜 영상을 만들 수 있다는 것만 기억하세요. ",
  ...
  deepfakeQuiz1: "지금 보신 영상은 생성형 AI가 만든 영상이었습니다. 놀랍게도 앞에 있는 앵커 조차 존재하지 않는 AI가 만든 얼굴이에요. 표정도 자연스럽고, 말투도 어색하지 않아서 진짜처럼 느끼셨죠? AI 기술이 이 정도로 정교해졌습니다. 그럼 다음 영상을 봐볼까요?",
  deepfakeQuiz2: "이번 영상도 딥페이크 영상이었습니다. 놀랍지 않으신가요? ",
  deepfakeQuizComplete: "이제 이 기술이 어떻게 가짜 뉴스에 활용되거나, 혹은 사람의 신원을 도용하는 데까지 쓰일 수 있는지 알아볼까요?",
...
export const FAKE_NEWS_MODULE_STEPS: ModuleStep[] = [
  ...
  { 
    ...
    videoUrl: "https://d3srmxrzq4dz1v.cloudfront.net/video-url/fakenews-1.mp4" 
  },
  // 5. Case 1: Wrap up
  { 
    id: 'fn_case1_wrapup', 
