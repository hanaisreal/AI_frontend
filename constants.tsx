...
export const SCRIPTS = {
  ...
  identityTheftDetectionTips: "가족 간에는 암호를 정해두고 전화가 오면 확인해보세요. 온라인에는 본인이나 가족 사진을 올리지 않는 것이 좋습니다. 휴대폰이 해킹되었을 때를 대비해, 연락처는 '딸', '아들' 같은 관계 대신 실제 이름으로 저장해두는 것이 좋아요. 그래야 가족 정보를 쉽게 파악하기 어렵습니다.",
