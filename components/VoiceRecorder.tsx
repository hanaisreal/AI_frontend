...
const VoiceRecorder: React.FC<VoiceRecorderProps> = ({ onRecordingComplete, scriptToRead, maxDuration = 60, isActive = false }) => {
  ...
  return (
    <div className="w-full">
      {/* Title section */}
      <label className="block text-base font-semibold text-slate-700 mb-3">음성 녹음</label>
        ...
        {scriptToRead && (
          <div className="p-6 border-b border-slate-200">
            <div className="text-center mb-6">
              <p className="text-lg font-semibold text-slate-700 mb-4">여러분이 강의를 한다 생각하고 다음 대본을 큰 소리로 읽어주세요~</p>
              ...
              {recordingState === RecordingState.IDLE && (
                <div className="mt-6 text-center">
                  <p className="text-base text-slate-600 mb-4">아래 "녹음 시작" 버튼을 클릭하고 대본을 읽어주세요.</p>
        ...
        <div className="flex flex-col items-center space-y-6 p-6">
          ...
          {recordingState === RecordingState.RECORDING && (
            <>
              ...
              <div className="flex items-center space-x-2">
                ...
                <p className="text-slate-700 text-lg">녹음 중: {formatTime(duration)}</p>
              </div>
            </>
          )}
          ...
          {recordingState === RecordingState.STOPPED && audioUrl && (
            <div className="text-center w-full space-y-4">
              <p className="text-green-600 text-lg">녹음 완료! 길이: {formatTime(duration)}</p>
