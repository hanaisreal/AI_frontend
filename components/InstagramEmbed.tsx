...
const InstagramEmbed: React.FC<InstagramEmbedProps> = ({ instagramUrl, caption }) => {
  useEffect(() => {
  ...
  return (
    <div className="instagram-embed-container my-6">
      ...
      {caption && (
        <p className="text-sm text-slate-600 mt-3 text-center italic">{caption}</p>
      )}
    </div>
  );
};
